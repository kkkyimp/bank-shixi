...
#log回归
logmodel = LogisticRegression(class_weight={0:0.07})
...
#while i<=25:
    #i=i+1
knn = KNeighborsClassifier(n_neighbors=1,weights='distance',p=2,metric='euclidean')
...
#i=0.01
#while i<=0.2:
svc= SVC(kernel = 'sigmoid',class_weight={0:0.04}, random_state = 121)
...
dtree = DecisionTreeClassifier(criterion='gini', splitter='best',class_weight={0:50},random_state = 131)
...
rfc = RandomForestClassifier(n_estimators = 100,class_weight={0:20},random_state = 141)#criterion = entopy,gini
...
xgb = XGBClassifier(objective='binary:logistic',eta=0.1,scale_pos_weight=10,n_estimators=100,max_dept=5,seed=1234)
